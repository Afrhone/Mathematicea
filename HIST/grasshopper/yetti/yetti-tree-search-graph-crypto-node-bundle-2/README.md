...
Start here before any public release:

```text
docs/runbooks/PUBLIC_RELEASE.md
docs/runbooks/TOKEN_RISK_DISCLOSURE.md
docs/runbooks/TOKENOMICS_DRAFT.md
docs/runbooks/LEGAL_SECURITY_GATES.md
docs/runbooks/WHITEPAPER_TEMPLATE.md
security/PUBLIC_RELEASE_SECURITY_CHECKLIST.md
```
