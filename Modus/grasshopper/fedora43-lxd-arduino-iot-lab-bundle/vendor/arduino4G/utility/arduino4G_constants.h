...
#include "arduino4G_error_codes.h"
...
const char LE910_string_10[]    PROGMEM = "AT+CSQ\r";                       //10
...
const char LE910_string_34[]    PROGMEM = "AT#PSNT?\r: ,";                  //34
...
const char LE910_string_38[]    PROGMEM = "AT#SHDN\r";                      //38
const char LE910_string_39[]    PROGMEM = "AT#ENHRST=1,0\r";                //39
const char LE910_string_40[]    PROGMEM = "+IP: ";                          //40

const char LE910_string_41[]    PROGMEM = "AT+WS46=%u\r";                   //41
const char LE910_string_42[]    PROGMEM = "+CMGL: ";                        //42
const char LE910_string_43[]    PROGMEM = "+CMGR: ";                        //43
const char LE910_string_44[]    PROGMEM = "AT+CEREG?\r";                    //44
const char LE910_string_45[]    PROGMEM = "+CEREG: 0,";                     //45
...
const char LE910_SMS_07[]   PROGMEM = "+CMGR:";                            //7
...
const char LE910_IP_SOCKET_33[] PROGMEM = "AT#SSLEN=1,%u\r";                //33
const char LE910_IP_SOCKET_34[] PROGMEM = "AT#SSLSECCFG=1,%u,%u\r";         //34
